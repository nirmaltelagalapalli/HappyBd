...
function setupMusicPlayer() {
        ...
        if (!isMusicStarted) {
            ...
            if (playPromise !== undefined) {
                playPromise.catch(error => {
                    ...
                    musicToggle.textContent = "🎵 Play Music"; // Show play button if autoplay fails
                });
            }
            isMusicStarted = true;
            musicToggle.textContent = "❌ Stop Music"; // Change button text to "Stop Music"
        }
    });
    ...
    musicToggle.addEventListener('click', () => {
        if (bgMusic.paused) {
            ...
            bgMusic.pause();
            musicToggle.textContent = "🎵 Play Music"; // Change button text to "Play Music"
        }
    });
}
